...
namespace IMABS.Controllers
{
	public class ContactUsController : Controller
	{
        ...
        public async Task<ActionResult> Index()
        {
            ...
            contactUsView.EnableCallToTactionBanner = contactUs.Fields.EnableCallToTactionBanner;
            contactUsView.EnablePromotionsBanner = contactUs.Fields.EnablePromotionsBanner;
            contactUsView.EnableBreadcrumb = contactUs.Fields.EnableBreadcrumb;
