...
namespace IMABS.Controllers
{
    public class BlockquoteContentController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            model.EnableCallToTactionBanner = bqc.Fields.EnableCallToTactionBanner;
            model.EnableBreadcrumb = bqc.Fields.EnableBreadcrumb;
            model.PageCTABanner = bqc.Fields.CTABanner;
