...
namespace IMABS.Controllers
{
    public class CareersController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            model.EnableCallToTactionBanner = careerPage.Fields.EnableCallToTactionBanner;
            model.EnablePromotionsBanner = careerPage.Fields.EnablePromotionsBanner;
            model.EnableBreadcrumb = careerPage.Fields.EnableBreadcrumb;
