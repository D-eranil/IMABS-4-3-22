...
namespace IMABS.Controllers
{
    public class LandingPageController : Controller
    {
        ...
        public async Task<ActionResult> Index(string NodeAliasPath)
        {
            ...
            model.EnableCallToTactionBanner = lp.Fields.EnableCallToTactionBanner;
            model.EnablePromotionsBanner = lp.Fields.EnablePromotionsBanner;
            model.EnableBreadcrumb = lp.Fields.EnableBreadcrumb;
